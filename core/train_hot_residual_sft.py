...
def main():
    ...
    training_args = TrainingArguments(
        ...
        save_total_limit=2,
        seed=args.seed,
        fp16=False,  # in False，mixed precision Accelerate 
        bf16=False,
        remove_unused_columns=False,
        report_to="none",
        save_strategy="no",      # do not let Trainer in train() inautomatically save checkpoint
        save_safetensors=False,  #  .bin ， safetensors  shared tensor （）
    )
